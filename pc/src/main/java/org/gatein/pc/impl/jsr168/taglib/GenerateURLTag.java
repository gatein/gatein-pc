 ...
 ******************************************************************************/
package org.gatein.pc.impl.jsr168.taglib;

import org.gatein.pc.impl.jsr168.api.PortletURLImpl;
...
public abstract class GenerateURLTag extends PortletTag
{
   ...
   private Map<String, List<String>> parameters = new HashMap<String, List<String>>(5);
   ...
   {
      Map<String, String[]> urlParameters = new HashMap<String, String[]>(parameters.size());
   ...
   public void addParameter(String name, String value)
   {
      ...
      List<String> o = (List<String>)parameters.get(name);
      if (o == null)
      {
   ...
   {
      parameters = new HashMap<String, List<String>>(5);
      // windowCtx = null;
      // preq = null;
   }
