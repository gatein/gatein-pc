 ...
 ******************************************************************************/
package org.gatein.pc.impl.jsr168;
...
import org.gatein.pc.container.PortletInitializationException;
import org.gatein.pc.container.PortletContainerContext;
import org.gatein.pc.container.object.PortletContainerObject;
import org.gatein.pc.impl.jsr168.api.ActionRequestImpl;
import org.gatein.pc.impl.jsr168.api.ActionResponseImpl;
import org.gatein.pc.impl.jsr168.api.PortletConfigImpl;
import org.gatein.pc.impl.jsr168.api.RenderRequestImpl;
import org.gatein.pc.impl.jsr168.api.RenderResponseImpl;
import org.gatein.pc.impl.jsr168.api.EventRequestImpl;
import org.gatein.pc.impl.jsr168.api.EventResponseImpl;
import org.gatein.pc.impl.jsr168.api.ResourceRequestImpl;
import org.gatein.pc.impl.jsr168.api.ResourceResponseImpl;
import org.gatein.pc.impl.jsr168.api.FilterChainImpl;
import org.gatein.pc.impl.jsr168.api.PortletRequestImpl;
import org.gatein.pc.impl.jsr168.api.PortletResponseImpl;
...
public class PortletContainerImpl implements PortletContainerObject
{
   ...
   /** . */
   private Set<org.gatein.pc.impl.jsr168.PortletFilterImpl> filters;
   ...
   public void addPortletFilter(org.gatein.pc.container.PortletFilter filter)
   {
      filters.add((PortletFilterImpl)filter);
   }

   public void removePortletFilter(org.gatein.pc.container.PortletFilter filter)
   {
   ...
   private <T extends PortletFilter> List<T> builderFilterList(Class<T> type)
   {
      ...
      {
         for (org.gatein.pc.impl.jsr168.PortletFilterImpl filter : filters)
         {
