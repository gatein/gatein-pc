...
package org.gatein.pc.embed.renderurl;
...
public class RenderURLTestCase extends AbstractTestCase
{
   ...
   {
      return deployment(RenderURLPortlet.class);
   }
   ...
   public void init()
   {
      Assert.assertEquals(0, RenderURLPortlet.count);
   }
   ...
   {
      URL url = deploymentURL.toURI().resolve("embed/RenderURLPortlet").toURL();
   ...
   {
      Assert.assertEquals(2, RenderURLPortlet.count);
   }
}
