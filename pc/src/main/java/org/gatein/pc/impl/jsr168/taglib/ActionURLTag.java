 ...
 * @jsp.tag name="actionURL" body-content="JSP" tei-class="org.gatein.pc.impl.jsr168.taglib.GenerateURLTagTEI"
 */
public class ActionURLTag extends GenerateURLTag
{
   ...
   /* (non-Javadoc)
    * @see org.gatein.pc.taglib.GenerateURLTag#addTypeParameter()
    */
