...
public class ActionCookieTestCase extends AbstractTestCase
{
   ...
   {
      return deployment(ActionCookiePortlet.class);
   }
   ...
   {
      URL url = deploymentURL.toURI().resolve("embed/ActionCookiePortlet").toURL();
      ...
      Assert.assertEquals("foo=bar", headers.get("Set-Cookie"));
   }
}
