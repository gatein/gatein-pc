...
public class ActionErrorTestCase extends AbstractTestCase
{
   ...
   {
      return deployment(ActionErrorPortlet.class);
   }
   ...
   {
      URL url = deploymentURL.toURI().resolve("embed/ActionErrorPortlet").toURL();
      ...
      Assert.assertTrue(s + " does not contain the _ActionError_ string", s.contains("_ActionError_"));
   }
}
