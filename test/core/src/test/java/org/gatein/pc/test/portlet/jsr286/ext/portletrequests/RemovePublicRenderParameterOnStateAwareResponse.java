 ...
 */
@TestCase({
   Assertion.EXT_PORTLET_REQUESTS_10
   })
public class RemovePublicRenderParameterOnStateAwareResponse
{
   public RemovePublicRenderParameterOnStateAwareResponse(PortletTestCase seq)
   {
