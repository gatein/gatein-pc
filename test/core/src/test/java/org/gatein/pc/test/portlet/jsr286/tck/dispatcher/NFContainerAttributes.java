...
public class NFContainerAttributes extends DispatchedContainerAttributes
{
   ...
   private static Map<String, String> buildInfo(ServletContext context)
   {
      Map<String, String> map = new HashMap<String, String>();
      map.put("request_uri", null);
      map.put("context_path", context.getContextPath());
   ...
   public NFContainerAttributes(PortletTestCase seq)
   {
