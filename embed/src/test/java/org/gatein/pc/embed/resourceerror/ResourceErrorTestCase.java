...
package org.gatein.pc.embed.resourceerror;
...
public class ResourceErrorTestCase extends AbstractTestCase
{
   ...
   {
      return deployment(ResourceErrorPortlet.class);
   }
   ...
   {
      URL url = deploymentURL.toURI().resolve("embed/ResourceErrorPortlet").toURL();
