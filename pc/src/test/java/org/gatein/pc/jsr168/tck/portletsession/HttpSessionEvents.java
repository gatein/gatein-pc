 ...
 ******************************************************************************/
package org.gatein.pc.jsr168.tck.portletsession;
...
public class HttpSessionEvents implements HttpSessionListener
{
   ...
   public static final ThreadLocal<List<Event>> threadLocal = new ThreadLocal<List<Event>>();

   public void sessionCreated(HttpSessionEvent event)
   {
      HttpSession session = event.getSession();
      List<Event> sessions = getEvents();
      if (sessions != null)
      {
   ...
   {
      return (List<Event>)threadLocal.get();
   }
