...
class PortletResourceRequestHandler extends RequestHandler<PortletResourceRequest>
{
   ...
   ControllerResponse processResponse(ControllerContext controllerContext, PortletResourceRequest request, PortletInvocationResponse response) throws PortletInvokerException
   {
