...
public class RIRIContainerAttributes extends DispatchedContainerAttributes
{
   ...
   {
      Map<String, String> map = new HashMap<String, String>();
      map.put("request_uri", ctx.getContextPath() + "/requestIncludeHopServlet/pathinfo1");
   ...
   public RIRIContainerAttributes(PortletTestCase seq)
   {
