 ...
 ******************************************************************************/
package org.gatein.pc.jsr168.ext.portletmode.extended;
...
public class TestActionWithPortletModePortlet extends AbstractUniversalTestPortlet
{
   ...
   public final static JoinPoint RENDER_JOIN_POINT = new JoinPoint(org.gatein.pc.jsr168.ext.portletmode.extended.TestActionWithPortletModePortlet.NAME, JoinPointType.PORTLET_RENDER);

   public final static JoinPoint ACTION_JOIN_POINT = new JoinPoint(org.gatein.pc.jsr168.ext.portletmode.extended.TestActionWithPortletModePortlet.NAME, JoinPointType.PORTLET_ACTION);
