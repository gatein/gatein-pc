...
import org.gatein.pc.impl.jsr168.PortletUtils;
...
public class PortalContextImpl implements javax.portlet.PortalContext
{
   ...
   private Set<javax.portlet.PortletMode> supportedPortletModes;
   private Set<javax.portlet.WindowState> supportedWindowStates;
   ...
   public Enumeration<javax.portlet.PortletMode> getSupportedPortletModes()
   {
      ...
      {
         Set<Mode> tmp = portal.getModes();
         supportedPortletModes = new HashSet<javax.portlet.PortletMode>(tmp.size());
         for (Iterator<Mode> i = tmp.iterator(); i.hasNext();)
         {
   ...
   public Enumeration<javax.portlet.WindowState> getSupportedWindowStates()
   {
      ...
      {
         Set<WindowState> tmp = portal.getWindowStates();
         supportedWindowStates = new HashSet<javax.portlet.WindowState>(tmp.size());
         for (Iterator<WindowState> i = tmp.iterator(); i.hasNext();)
         {
