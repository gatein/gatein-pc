...
package org.gatein.pc.unit.reports;
...
public class TestCaseAnnotationProcessor implements AnnotationProcessor
{
   ...
   public static String jsr168Pre = "org.gatein.pc.jsr168";

   public static String jsr286Pre = "org.gatein.pc.jsr286";
   ...
   public TestCaseAnnotationProcessor(AnnotationProcessorEnvironment env) {
      ...
      environment = env;
		testCaseDeclaration = (AnnotationTypeDeclaration) environment
				.getTypeDeclaration("org.gatein.pc.unit.annotations.TestCase");
	}
