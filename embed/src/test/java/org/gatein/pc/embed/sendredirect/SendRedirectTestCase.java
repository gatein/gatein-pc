...
package org.gatein.pc.embed.sendredirect;
...
public class SendRedirectTestCase extends AbstractTestCase
{
   ...
   {
      return deployment(SendRedirectPortlet.class);
   }
   ...
   {
      URL url = deploymentURL.toURI().resolve("embed/SendRedirectPortlet").toURL();
      ...
      Assert.assertTrue(headers.containsKey("Location"));
      Assert.assertEquals("http://www.foo.com", headers.get("Location"));
   }
}
