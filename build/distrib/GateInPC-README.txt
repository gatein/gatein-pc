...
GateIn Portlet Container provides a standard-compliant implementation of the JSR-286 Portlet 2.0 
...
portal can be run on Tomcat 6.x, JBoss Application Server 4.2.x and JBoss Application Server 5.1.x.
