...
import org.gatein.pc.test.portlet.jsr168.tck.preferences.spec.CreateASingleInstanceOfValidatorValidator;
...
public class CreateASingleInstanceOfValidator
{
   public CreateASingleInstanceOfValidator(PortletTestCase seq)
   {
