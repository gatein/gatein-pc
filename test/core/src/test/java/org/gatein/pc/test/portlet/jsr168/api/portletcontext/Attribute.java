 ...
 ******************************************************************************/
package org.gatein.pc.test.portlet.jsr168.api.portletcontext;
 ...
 */
@TestCase({
   Assertion.API286_PORTLET_CONTEXT_1,
   Assertion.API286_PORTLET_CONTEXT_17,
   Assertion.API286_PORTLET_CONTEXT_18})
public class Attribute
{
   public Attribute(PortletTestCase seq)
   {
